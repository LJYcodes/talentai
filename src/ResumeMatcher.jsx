...
const AI = async (prompt, max = 1600) => {
  const r = await fetch("https://api.anthropic.com/v1/messages", {
    method:"POST", headers:{"Content-Type":"application/json","x-api-key":"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","anthropic-version":"2023-06-01","anthropic-dangerous-direct-browser-access":"true"},
